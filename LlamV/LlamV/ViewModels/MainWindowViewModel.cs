...
namespace LlamV.ViewModels
{
    public class MainWindowViewModel : WorkspaceBase
    {
        ...
        public ReactiveProperty<bool> Property { get; private set; }
        public ReactiveProperty<bool> Editor { get; private set; }
        public ReactiveProperty<bool> Output { get; private set; }
        //Modelとの連携
        ...
        protected override void InitializeTools()
        {
            ...
            var p1 = new PropertyTool();
            model.Tools.Add(p1);
            Property = p1.ToReactivePropertyAsSynchronized(x => x.IsVisible);

            var p2 = new EditorTool();
            model.Tools.Add(p2);
            Editor = p2.ToReactivePropertyAsSynchronized(x => x.IsVisible);
